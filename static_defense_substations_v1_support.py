# -*- coding: utf-8 -*-
"""
Created on Wed Jun 21 17:00:28 2017
...
def greedy_hueristics(filepath, comp_filename, load_file_name, start_range, contingency_range, blackout_criterion, system_name, p_budget, s_budget, sub_name, protected_substation):
    import time
...
#    import maptest_testing_trimmed
    ...
    for sub_budget in range(0, s_budget):
        if (worst_case_sub == []):
            subs_config_dict = maptest_testing.maptest14bus_test_system(comp_filename, start_range, contingency_range, sub_name, protected_substation);
        else:
            subs_config_dict = trimmed_list.maptest14bus_test_system(comp_filename, start_range, contingency_range, worst_case_sub, sub_name, protected_substation);
